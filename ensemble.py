...
RSI_signals = functions.Bots(ohlcv_df).RSI_bot(overbought_threshold = 70, oversold_threshold = 30, window = 14)
VWAP_signals = functions.Bots(ohlcv_df).VWAP_bot(window = 20)
Stochastic_Oscillator_signals = functions.Bots(ohlcv_df).stochastic_oscillator_bot(oscillator_window = 14, signal_window = 3, overbought_threshold = 80, oversold_threshold = 20)
