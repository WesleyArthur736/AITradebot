...
for generation in range(1, number_of_generations + 1):
    ...
    for crossover in range(0,len(population_with_info)):
        ...
        child_buy_dnf, child_sell_dnf, child_trade_signals = child_ensemble_bot.generate_signals(child_buy_dnf, child_sell_dnf)
...
utils.plot_trading_simulation([population_with_info[0][3]], ["Ensemble Bot"], f"Best Ensemble Bot After {number_of_generations} Generations (Population = {population_size})")
