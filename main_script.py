...
def run_ensemble_bots_non_optimal_and_optimal(Non_Optimized_constituent_bot_parameters, Optimized_constituent_bot_parameters):
    best_ensemble_bot_non_optimised = erwin_ensemble_ga.ensemble_ga(constituent_bot_parameters=Non_Optimized_constituent_bot_parameters, population_size=500, number_of_generations=20, mutation_rate=0.1)
    best_ensemble_bot_optimised = erwin_ensemble_ga.ensemble_ga(constituent_bot_parameters=Optimized_constituent_bot_parameters, population_size=500, number_of_generations=20, mutation_rate=0.1)
